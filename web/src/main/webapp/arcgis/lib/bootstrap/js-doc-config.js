define({
	...
	exporters: [ { id: 'dojov1', config: { file: './api-doc/details.xml' } } ],
	...
	basePath: '/Users/karmstrong/dev/dojo-release-1.8.3-src',
	...
	packages: {
		bootstrap: '../../Dropbox/Development/projects/dev.dojobootstrap/2x'
	},
